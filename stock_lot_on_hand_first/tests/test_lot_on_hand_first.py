...
class TestLotOnHandFirst(SavepointCase):
    ...
    def test_lot_on_hand_first(self):
        ...
        name_get_res = self.env["stock.production.lot"].with_context(
    ...
    def test_lot_on_hand_first_with_limit(self):
        ...
        lot_7 = self._create_lot(self.product, "LOT-000007", 0)
        lot_8 = self._create_lot(self.product, "LOT-000008", 0)
